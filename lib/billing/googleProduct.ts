/** Google Play one-time product ID (Play Console). */
export const GOOGLE_FULL_ACCESS_PRODUCT_ID = 'lingotheory_full_access';

/** Purchase option ID within the one-time product (Play Console). */
